        ...
        <>
            ...
            <div className="lg:hidden fixed top-4 left-4 z-50">
                <button
                    ...
                    className="bg-slate-800 text-gray-200 p-2 rounded-lg shadow-lg hover:bg-slate-700"
                >
            ...
            {/* Sidebar */}
            <aside className={`
                fixed top-0 left-0 h-full w-64 bg-slate-900 border-r border-slate-700 flex flex-col z-40 transition-transform duration-300
            ...
            `}>
                ...
                <nav className="flex-1 p-6">
                    <ul className="space-y-2">
                        ...
                        {/* Temporarily commented out Market Analysis
                        <NavLink 
                            href="/market" 
                            icon={<MarketIcon />} 
                ...
                <div className="p-6 border-t border-slate-700">
                    <div className="flex items-center justify-between">
                        ...
                        <button 
                            ...
                            className="text-gray-500 hover:text-violet-400 p-1 rounded-md disabled:opacity-50"
                            title="Sign Out"
                        >
                            {isLoggingOut ? (
